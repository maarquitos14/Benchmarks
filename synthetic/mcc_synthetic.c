...
void synthetic_mcc_serial(int n, int *res)
{
  if (n == 0)
    {
      *res = 1;
  ...
  else
    {
      ...
      if (n - 2 >= 0)
        {
          synthetic_mcc_serial(n - 2, &tmp1);
        }
      if (n - 1 >= 0)
        {
          synthetic_mcc_serial(n - 1, &tmp2);
        }
      *res = tmp1 + tmp2;
    }
}
...
static void nanos_xlate_fun_syntheticc_0(struct nanos_args_0_t *const arg, void *wd)
{
  {
...
static void nanos_xlate_fun_syntheticc_1(struct nanos_args_1_t *const arg, void *wd)
{
  {
    void *device_base_address;
    nanos_err_t err;
...
static void smp_ol_synthetic_1(struct nanos_args_0_t *const args);
...
static void smp_ol_synthetic_3(struct nanos_args_1_t *const args);
                ...
                {
                  {
                    ...
                    static nanos_smp_args_t smp_ol_synthetic_1_args = {.outline = (void (*)(void *))(void (*)(struct nanos_args_0_t *))&smp_ol_synthetic_1};
                    static struct nanos_const_wd_definition_1 nanos_wd_const_data = {.base = {.props = {.mandatory_creation = 0, .tied = 0, .clear_chunk = 0, .reserved0 = 0, .reserved1 = 0, .reserved2 = 0, .reserved3 = 0, .reserved4 = 0}, .data_alignment = __alignof__(struct nanos_args_0_t), .num_copies = 1, .num_devices = 1, .num_dimensions = 1, .description = "synthetic"}, .devices = {[0] = {.factory = &nanos_smp_factory, .arg = &smp_ol_synthetic_1_args}}};
                    ...
                    if (nanos_wd_ != (void *)0)
                      {
                        ...
                        err = nanos_set_translate_function(nanos_wd_, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_0);
                        if (err != NANOS_OK)
                          {
                            nanos_handle_error(err);
                          }
                    ...
                    else
                      {
                        ...
                        err = nanos_create_wd_and_run_compact(&nanos_wd_const_data.base, &nanos_wd_dyn_props, sizeof(struct nanos_args_0_t), &imm_args, 1, dependences, imm_copy_data, imm_copy_dimensions, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_0);
                        if (err != NANOS_OK)
                          {
                            nanos_handle_error(err);
                          }
                ...
                {
                  {
                    ...
                    static nanos_smp_args_t smp_ol_synthetic_3_args = {.outline = (void (*)(void *))(void (*)(struct nanos_args_1_t *))&smp_ol_synthetic_3};
                    static struct nanos_const_wd_definition_1 nanos_wd_const_data = {.base = {.props = {.mandatory_creation = 0, .tied = 0, .clear_chunk = 0, .reserved0 = 0, .reserved1 = 0, .reserved2 = 0, .reserved3 = 0, .reserved4 = 0}, .data_alignment = __alignof__(struct nanos_args_1_t), .num_copies = 1, .num_devices = 1, .num_dimensions = 1, .description = "synthetic"}, .devices = {[0] = {.factory = &nanos_smp_factory, .arg = &smp_ol_synthetic_3_args}}};
                    nanos_wd_dyn_props.tie_to = 0;
                    nanos_wd_dyn_props.priority = 0;
                    nanos_wd_dyn_props.flags.is_final = 0;
                    ...
                    if (nanos_wd_ != (void *)0)
                      {
                        ...
                        ol_copy_data[0].dimensions = &ol_copy_dimensions[0];
                        ol_copy_data[0].offset = 0;
                        err = nanos_set_translate_function(nanos_wd_, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_1);
                        if (err != NANOS_OK)
                          {
                            nanos_handle_error(err);
                          }
                    ...
                    else
                      {
                        ...
                        imm_copy_data[0].dimensions = &imm_copy_dimensions[0];
                        imm_copy_data[0].offset = 0;
                        err = nanos_create_wd_and_run_compact(&nanos_wd_const_data.base, &nanos_wd_dyn_props, sizeof(struct nanos_args_1_t), &imm_args, 1, dependences, imm_copy_data, imm_copy_dimensions, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_1);
                        if (err != NANOS_OK)
                          {
                            nanos_handle_error(err);
                          }
...
static void nanos_xlate_fun_syntheticc_2(struct nanos_args_2_t *const arg, void *wd)
{
  {
    void *device_base_address;
    nanos_err_t err;
...
static void smp_ol_synthetic_5(struct nanos_args_2_t *const args);
        ...
        {
          {
            ...
            static nanos_smp_args_t smp_ol_synthetic_5_args = {.outline = (void (*)(void *))(void (*)(struct nanos_args_2_t *))&smp_ol_synthetic_5};
            static struct nanos_const_wd_definition_1 nanos_wd_const_data = {.base = {.props = {.mandatory_creation = 0, .tied = 0, .clear_chunk = 0, .reserved0 = 0, .reserved1 = 0, .reserved2 = 0, .reserved3 = 0, .reserved4 = 0}, .data_alignment = __alignof__(struct nanos_args_2_t), .num_copies = 1, .num_devices = 1, .num_dimensions = 1, .description = "synthetic"}, .devices = {[0] = {.factory = &nanos_smp_factory, .arg = &smp_ol_synthetic_5_args}}};
            nanos_wd_dyn_props.tie_to = 0;
            nanos_wd_dyn_props.priority = 0;
            nanos_wd_dyn_props.flags.is_final = 0;
            ...
            if (nanos_wd_ != (void *)0)
              {
                ...
                ol_copy_data[0].dimensions = &ol_copy_dimensions[0];
                ol_copy_data[0].offset = 0;
                err = nanos_set_translate_function(nanos_wd_, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_2);
                if (err != NANOS_OK)
                  {
                    nanos_handle_error(err);
                  }
            ...
            else
              {
                ...
                imm_copy_data[0].dimensions = &imm_copy_dimensions[0];
                imm_copy_data[0].offset = 0;
                err = nanos_create_wd_and_run_compact(&nanos_wd_const_data.base, &nanos_wd_dyn_props, sizeof(struct nanos_args_2_t), &imm_args, 1, dependences, imm_copy_data, imm_copy_dimensions, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_syntheticc_2);
                if (err != NANOS_OK)
                  {
                    nanos_handle_error(err);
                  }
...
static void smp_ol_synthetic_1_unpacked(int n, int *res)
{
  {
    {
      _Bool is_memoized;
      int *memo_dimensions = nanos_memo_get_dimensions(nanos_current_wd());
      is_memoized = nanos_memo_task_memoized(nanos_current_wd(), 0 + n % 5);
      if (!is_memoized)
        {
          synthetic(n, res);
          nanos_memo_store_task(nanos_current_wd(), 0 + n % 5);
        }
    }
  }
}
...
{
  {
    smp_ol_synthetic_1_unpacked((*args).n, (*args).res);
  }
}
static void smp_ol_synthetic_3_unpacked(int n, int *res)
{
  {
    {
      _Bool is_memoized;
...
{
  {
    smp_ol_synthetic_3_unpacked((*args).n, (*args).res);
  }
}
static void smp_ol_synthetic_5_unpacked(int n, int *res)
{
  {
    {
      _Bool is_memoized;
...
{
  {
    smp_ol_synthetic_5_unpacked((*args).n, (*args).res);
  }
}
